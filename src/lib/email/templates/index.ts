/** Barrel: alle ARC-ONE Transaktionsmail-Vorlagen + ihre Props. */
export { DepositConfirmationEmail, type DepositConfirmationProps } from './deposit-confirmation'
export {
  ShopPurchaseConfirmationEmail,
  type ShopPurchaseConfirmationProps,
  type ShopPurchaseItem,
